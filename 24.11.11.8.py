...
verbs = [
    ...
    "work", "live", "talk", "walk", "see", "hear", "feel", "understand", "belong", "believe", "want", "need",
...
def generate_sentence(tense="present"):
    ...
    # Ensure subject and object compatibility
    verb = weighted_random_choice(verbs, word_probabilities["verbs"])
    
    # Adjust verb selection for context (e.g., if it's about food or an animal, avoid "run")
